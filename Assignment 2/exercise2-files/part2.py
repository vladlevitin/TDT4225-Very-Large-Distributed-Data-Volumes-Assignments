...
class SQLQueries:
    def __init__(self) -> None:
        ...
        self.part1 = {table_name: f'SELECT * FROM {table_name} LIMIT 10;' for table_name in ['User', 'Activity', 'TrackPoint']}
        ...
        # Sot the result by the number of activities in descending order.
